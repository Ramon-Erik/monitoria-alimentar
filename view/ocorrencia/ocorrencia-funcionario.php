...
<?php/*
    ...
    <main>
        ...
        <select class="minimal" name="oq_ocor">
                            <option name= "oq_ocor" value="atrasa-comida">Atrasar a entrega da comida</option>
                            <option name= "oq_ocor" value="atrasa_utens">Atrasar a entrega dos utensílios</option>
                            <option name= "oq_ocor" value="amb_sujo">Ambiente de trabalho insalubre e sujo</option>
                            <option name= "oq_ocor" value="Neg_asseio">Negligenciar o asseio da comida</option>
        </select>
