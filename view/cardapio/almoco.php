    ...
    <main>
        ...
        <form action="../../control/cardapio-almoco.php" method="post" autocomplete="off">
            ...
            <dialog id="confirmarId">
                <div class="cabecalho">
                    <div class="linha-cab">
                        <h3>Almoço do dia <span id="dataId"></span></h3>
                    </div>
                </div>
                <div class="linha">
                    <p>Foi servido <span id="proteinaId"></span>, <span id="carboidratoId"></span>, <span id="verduraId"></span>, <span id="legumeId"></span>, <span id="frutaId"></span>, <span id="sucoId"></span> e <span id="sucoId"></span>.</p>
                </div>
